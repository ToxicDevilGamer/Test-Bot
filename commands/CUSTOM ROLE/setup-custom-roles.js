...
module.exports = {
  name: "setup-customrole",
  aliases: ['setrole', 'setuprole'],
  category : "setup",
   description: "Add User To Friend Database & Role In Guild",
...
if(!list){
    ...
    .addFields(
        { name: '```${prefix}setup```', value: 'This command will show this page.', inline: false },
        { name: '```${prefix}setup reqrole```', value: 'It will setup the required role to run some custom role commands.', inline: false },
        { name: '```${prefix}setup official```', value: 'Sets the official role.', inline: false },
        { name: '```${prefix}setup friend```', value: 'Sets the friend role.', inline: false },
        { name: '```${prefix}setup guest```', value: 'Sets the guest role.', inline: false },
        { name: '```${prefix}setup vip```', value: 'Sets the vip role.', inline: false },
        { name: '```${prefix}setup girl```', value: 'Sets the girl role.', inline: false },
        { name: '```${prefix}setup config```', value: 'Shows the current config of Custom Role.', inline: false },
        { name: '```${prefix}setup reset```', value: 'Shows the current config of Custom Role.', inline: false },
