...
module.exports = {
  ...
  userpermissions: ["MANAGE_GUILD"],
    ...
    if(!args[0]) return message.channel.send(`<:emoji_1:1183803270527983656> | specify the command \`create <cmd> <response>\``)
    ...
    try {
      ...
      if(!data) {
        if(!args[1]) return message.channel.send(`<:emoji_1:1183803270527983656> | specify the response \`create <cmd> <response>\``)
