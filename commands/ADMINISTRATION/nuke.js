...
run: async (client, message, args) => {
    ...
    const filter = (interaction) => {
      ...
      return interaction.reply({
        content: "Only Message User Can use this button",
        ephemeral: true,
      });
    };
    ...
    collector.on("collect", (buttonInteraction) => {
      ...
      if (id === "YES") {
       ...
       //.setImage("https://media.discordapp.net/attachments/832980836659494944/833749914336493638/boom.gif");
